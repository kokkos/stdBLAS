...
void kokkos_blas_updating_hemv_impl(A_t A, Triangle t, x_t x, y_t y, z_t z)
{
...
#ifdef USE_UPPER
TEST_F(blas2_signed_float_fixture, kokkos_updating_hem_matrix_vector_product_upper)
{
  namespace stdla = std::experimental::linalg;
  kokkos_blas_updating_hemv_impl(A_hem_e0, stdla::upper_triangle, x_e0, y_e0, z_e0);
}

TEST_F(blas2_signed_double_fixture, kokkos_updating_hem_matrix_vector_product_upper)
{
  namespace stdla = std::experimental::linalg;
  kokkos_blas_updating_hemv_impl(A_hem_e0, stdla::upper_triangle, x_e0, y_e0, z_e0);
}

TEST_F(blas2_signed_complex_double_fixture, kokkos_updating_hem_matrix_vector_product_upper)
{
  namespace stdla = std::experimental::linalg;
...
#ifdef USE_LOWER
TEST_F(blas2_signed_float_fixture, kokkos_updating_hem_matrix_vector_product_lower)
{
  namespace stdla = std::experimental::linalg;
  kokkos_blas_updating_hemv_impl(A_hem_e0, stdla::lower_triangle, x_e0, y_e0, z_e0);
}

TEST_F(blas2_signed_double_fixture, kokkos_updating_hem_matrix_vector_product_lower)
{
  namespace stdla = std::experimental::linalg;
  kokkos_blas_updating_hemv_impl(A_hem_e0, stdla::lower_triangle, x_e0, y_e0, z_e0);
}

TEST_F(blas2_signed_complex_double_fixture, kokkos_updating_hem_matrix_vector_product_lower)
{
  namespace stdla = std::experimental::linalg;
  using kc_t = Kokkos::complex<double>;
  using stdc_t = value_type;
