...
{
  kokkos_matrix_one_norm_test_impl(A, static_cast<value_type>(0), false);
}

TEST_F(blas2_signed_float_fixture, kokkos_matrix_one_norm_initvalue)
{
  kokkos_matrix_one_norm_test_impl(A, static_cast<value_type>(5.6), true);
}
...
{
  kokkos_matrix_one_norm_test_impl(A, static_cast<value_type>(5), true);
}
...
{
  kokkos_matrix_one_norm_test_impl(A, static_cast<double>(0), false);
}

TEST_F(blas2_signed_complex_double_fixture, kokkos_matrix_one_norm_initvalue)
{
  kokkos_matrix_one_norm_test_impl(A, static_cast<double>(5), true);
}
